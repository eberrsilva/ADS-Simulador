...
# Add a legend
legend(x=1.3, y=1, legend = rownames(data_grafico_spider_1[-c(1,2),]), bty = "n", pch=20 , col=colors_in , text.col = "grey", cex=1.2, pt.cex=3)
...
# Add a legend
legend(x=1.3, y=1, legend = rownames(data_grafico_spider_2[-c(1,2),]), bty = "n", pch=20 , col=colors_in , text.col = "grey", cex=1.2, pt.cex=3)
...
# Add a legend
legend(x=1, y=1, legend = rownames(data_grafico_spider_3[-c(1,2),]), bty = "n", pch=20 , col=colors_in , text.col = "grey", cex=1.2, pt.cex=3)
